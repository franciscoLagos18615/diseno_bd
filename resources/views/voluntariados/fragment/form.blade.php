...
<div class="form-group">
	{!! Form::label('tipo_trabajo', 'Tipo de trabajo del Voluntariado') !!}
	{!! Form::text('tipo_trabajo', null, ['class' => 'form-control']) !!}
</div>

<div class="form-group">
	{!! Form::label('personas', 'Cantidad de personas necesarias') !!}

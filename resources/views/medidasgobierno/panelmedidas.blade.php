		...
		<table class="table table-hover table-striped">
			...
			<tbody>
				...
				<tr>
						...
						<td>
						<?php if($recoleccion->avance<60): ?>
						<?php echo "<strong style='color:red;'> {$recoleccion->avance}% </strong>"; ?>
						<?php else: ?>
						<?php echo "<strong style='color:green;'> {$recoleccion->avance}% </strong>"; ?>
						<?php endif ?>						
						</td>
						<td>
		...
		<table class="table table-hover table-striped">
			...
			<tbody>
				...
				<tr>
						...
						<td>
						<?php if($evento->avance<60): ?>
						<?php echo "<strong style='color:red;'> {$evento->avance}% </strong>"; ?>
						<?php else: ?>
						<?php echo "<strong style='color:green;'> {$evento->avance}% </strong>"; ?>
						<?php endif ?>						
						</td>
						<td>
		...
		<table class="table table-hover table-striped">
			...
			<tbody>
				...
				<tr>
						...
						<td>
						<?php if($voluntariado->avance<60): ?>
						<?php echo "<strong style='color:red;'> {$voluntariado->avance}% </strong>"; ?>
						<?php else: ?>
						<?php echo "<strong style='color:green;'> {$voluntariado->avance}% </strong>"; ?>
						<?php endif ?>						
						</td>
						<td>
		...
		<table class="table table-hover table-striped">
			...
			<tbody>
				...
				<tr>
						...
						<td>
						<?php if($apoyoeconomico->avance<60): ?>
						<?php echo "<strong style='color:red;'> {$apoyoeconomico->avance}% </strong>"; ?>
						<?php else: ?>
						<?php echo "<strong style='color:green;'> {$apoyoeconomico->avance}% </strong>"; ?>
						<?php endif ?>						
						</td>
						<td>
